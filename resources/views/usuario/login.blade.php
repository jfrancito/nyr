...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <link rel="icon" href="{{ asset('public/img/icono/nyr.ico') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/css/meta.css?v='.$version) }} "/>


    <title>NyR - Inicio Sessión</title>
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
              ...
              <img src="{{ asset('public/img/nyr.png') }}" alt="logo" width="200" height="130" class="logo-img">
