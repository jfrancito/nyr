          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Historial Controles
                </div>
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    ...
                    @include('atenderpaciente.ajax.alistacontrolpaciente')
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Atender Paciente {{date_format(date_create($control->fecha_control), 'd-m-Y')}}
                </div>
                <div class="panel-body">
                  <div class='filtrotabla row'>
                    <div class="col-xs-12">
